...
var TEMPLATE = 'define([\'angular\'], function() {\n' +
        'angular.module(\'%s\', []).run([\'$templateCache\', function($templateCache) {\n' +
        '  $templateCache.put(\'%s\',\n    \'%s\');\n' +
        '}]);\n' +
    '});\n';

var SINGLE_MODULE_TPL = 'define([\'angular\'], function() {\n' +
        'try {\n' +
...
createHtml2JsPreprocessor.$inject = ['logger', 'config.basePath', 'config.ngRequireHtml2JsPreprocessor'];
